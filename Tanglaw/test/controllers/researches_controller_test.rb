...
class ResearchesControllerTest < ActionController::TestCase
  ...
  test "should create research" do
    assert_difference('Research.count') do
      post :create, research: { abstract: @research.abstract, author: @research.author, future: @research.future, significance: @research.significance, title: @research.title }
    end
  ...
  test "should update research" do
    patch :update, id: @research, research: { abstract: @research.abstract, author: @research.author, future: @research.future, significance: @research.significance, title: @research.title }
    assert_redirected_to research_path(assigns(:research))
  end
